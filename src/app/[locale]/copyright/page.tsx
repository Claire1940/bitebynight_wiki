...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Bite By Night Wiki',
    description: 'Copyright and intellectual property information for Bite By Night Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Bite By Night Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Bite By Night Wiki',
      description: 'Copyright and intellectual property information for Bite By Night Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Bite By Night Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Bite By Night Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Bite By Night Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>OzelBlox / Totally Not Secret Games</strong> - Creators of the Bite By Night game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Bite By Night</strong> - Trademark of the game developers</li>
              <li><strong>Bite By Night Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Bite By Night Wiki.
            </p>
            ...
            <p>
              ...
              Bite By Night Wiki<br />
              Email: <a href="mailto:dmca@bitebynight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bitebynight.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Bite By Night Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Bite By Night Wiki (bitebynight.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@bitebynight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@bitebynight.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@bitebynight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bitebynight.wiki</a>
            </p>
            <p>
